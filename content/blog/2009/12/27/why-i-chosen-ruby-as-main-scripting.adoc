= Why I have chosen Ruby as main scripting language for my toolbox
Orest Ivasiv
2009-12-27
:jbake-type: post
...
image::{my-image-dir}/blog/ruby.png[float="right"]

*UPD*: This post was written http://halyph.blogspot.com/2009/12/why-i-chosen-ruby-as-main-scripting.html[long time ago]. I have decided to re-publish it for historical reason
...
- *JavaScript*. I like this language, but it doesn't have standard serve-side API. There are a lot of implementation, but community have to work a lot to get valuable result. Check http://wiki.commonjs.org/wiki/CommonJS[CommonJS] to get more info
...
== References
- Original post: http://halyph.blogspot.de/2009/12/why-i-chosen-ruby-as-main-scripting.html
