...
You’ve probably heard about {my-link-gradle-kotlin}[_"Kotlin-based approach to writing Gradle build scripts"_]. A lot of noise was produced based on this announcement and Cédric Champeau tried to explain the real state of {my-link-cedric}[Groovy, Gradle and their future relationship].
