...
:jbake-tags: scala, conference
:source-highlighter: prettify
:icons: font
:my-image-dir: /images
:curr-post: /blog/2018/05/20
...
=== *Opening Keynote: 2.13 And Beyond* by https://twitter.com/odersky[Martin Odersky] and https://twitter.com/adriaanm[Adriaan Moors] (https://www.slideshare.net/Odersky/preparing-for-scala-3[slides])
...
image::{curr-post}/scala3.jpeg[float="center"]

== Day 2 (May 16, 2018)

=== *Keynote: Functionalist programming language design* by https://twitter.com/tomaspetricek[Tomas Petricek]
[quote]
____
...
=== *Akka: Present and Future* by https://twitter.com/chbatey[Christopher Batey] (http://batey.info/talks/akka-state/[slides])
[quote]
____
...
=== *What can Lagom do for you?* by https://twitter.com/renatocaval[Renato Cavalcanti]
[quote]
____
...
=== *Dive into Deep Learning with Scala* by https://twitter.com/soebrunk[Sören Brunk]
...
=== *A pragmatic introduction to Category Theory* by https://twitter.com/danielasfregola[Daniela Sfregol] (https://speakerdeck.com/danielasfregola/scala-days-2018-berlin-a-pragmatic-introduction-to-category-theory[slides])
...
=== *sbt 1* by https://twitter.com/eed3si9n[Eugene Yokota] and https://twitter.com/dwijnand[Dale Wijnand]
____
...
=== *Starting from Scratch with Scala Native* by https://twitter.com/RichardWhaling[Richard Whaling]
____
...
=== *Compiling Scala Faster with GraalVM* by https://twitter.com/vojjov[Vojin Jovanovic]
____
...
=== *Functional interpreters and you* by https://twitter.com/davegurnell[Dave Gurnell] (https://github.com/underscoreio/interpreters-and-you[slides and code])
____
...
=== *Strings are Evil: Methods to hide the use of primitive types* by https://twitter.com/noelwelsh[Noel Welsh]
____
...
=== *Full Stack Scala* by https://twitter.com/tbjerkes[Trond Bjerkestrand] (https://www.youtube.com/watch?v=NNietlUelMQ[video - ScalaIO FR])
____
...
=== *Applications of Implicit Function Types* by https://github.com/OlivierBlanvillain[Olivier Blanvillain] (https://docs.google.com/presentation/d/19-ZfP-51wstP2CDALISJhSRL2YX-ozJD6uqF4ic7a7g/edit[slides])
____
